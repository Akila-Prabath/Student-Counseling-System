                                            ...
                                            <img
                                                src={
                                                    appt.student?.profilePic
                                                        ? `${process.env.REACT_APP_API_URL || "http://localhost:8070"}/uploads/${appt.student.profilePic}`
                                                        : `https://ui-avatars.com/api/?name=${encodeURIComponent(appt.student?.name || "User")}`
                                                }
                                                alt="student"
